...
void EmptyLinkFunctionForGeneratedCodeOEIVoiceOver_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_OEIVoiceOver()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_OEIVoiceOver_VoiceOverPlaybackStartedDynamicDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_OEIVoiceOver_VoiceOverLoadFinishedDynamicDelegate__DelegateSignature,
			};
