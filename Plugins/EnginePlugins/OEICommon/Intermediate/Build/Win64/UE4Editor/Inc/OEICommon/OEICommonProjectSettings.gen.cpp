...
#include "OEICommon/Public/OEICommonProjectSettings.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeOEICommonProjectSettings() {}
// Cross Module References
	OEICOMMON_API UClass* Z_Construct_UClass_UOEICommonProjectSettings_NoRegister();
	OEICOMMON_API UClass* Z_Construct_UClass_UOEICommonProjectSettings();
	DEVELOPERSETTINGS_API UClass* Z_Construct_UClass_UDeveloperSettings();
	UPackage* Z_Construct_UPackage__Script_OEICommon();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FSoftClassPath();
// End Cross Module References
	void UOEICommonProjectSettings::StaticRegisterNativesUOEICommonProjectSettings()
	{
	}
	UClass* Z_Construct_UClass_UOEICommonProjectSettings_NoRegister()
	{
		return UOEICommonProjectSettings::StaticClass();
	}
	struct Z_Construct_UClass_UOEICommonProjectSettings_Statics
	{
		static UObject* (*const DependentSingletons[])();
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Class_MetaDataParams[];
#endif
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_Packages_Inner;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_Packages_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_Packages;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_CrashBuddyConfigFile_MetaData[];
#endif
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_CrashBuddyConfigFile;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ChatterEventQueueTime_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_ChatterEventQueueTime;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ChatterEventWaitTime_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_ChatterEventWaitTime;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ChatterEventQueueProcessLimit_MetaData[];
#endif
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_ChatterEventQueueProcessLimit;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bShowTextReviewPrefixes_MetaData[];
#endif
		static void NewProp_bShowTextReviewPrefixes_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bShowTextReviewPrefixes;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_WorldRuntimeClassName_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_WorldRuntimeClassName;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ExportedFolder_MetaData[];
#endif
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_ExportedFolder;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DesignSourceFolder_MetaData[];
#endif
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_DesignSourceFolder;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DesignStagingFolder_MetaData[];
#endif
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_DesignStagingFolder;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_OverrideFolder_MetaData[];
#endif
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_OverrideFolder;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_QuickSaveFilename_MetaData[];
#endif
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_QuickSaveFilename;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SaveBeforeLinkFilename_MetaData[];
#endif
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_SaveBeforeLinkFilename;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_AutoSaveFilename_MetaData[];
#endif
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_AutoSaveFilename;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SaveFileExtension_MetaData[];
#endif
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_SaveFileExtension;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
		static const FCppClassTypeInfoStatic StaticCppClassTypeInfo;
		static const UE4CodeGen_Private::FClassParams ClassParams;
	};
	UObject* (*const Z_Construct_UClass_UOEICommonProjectSettings_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_UDeveloperSettings,
		(UObject* (*)())Z_Construct_UPackage__Script_OEICommon,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOEICommonProjectSettings_Statics::Class_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "IncludePath", "OEICommonProjectSettings.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOEICommonProjectSettings_Statics::NewProp_Packages_MetaData[] = {
		...
		{ "Category", "OEICommonProjectSettings" },
		{ "ModuleRelativePath", "Public/OEICommonProjectSettings.h" },
	};
#endif
...
#endif
	void Z_Construct_UClass_UOEICommonProjectSettings_Statics::NewProp_bShowTextReviewPrefixes_SetBit(void* Obj)
	{
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UOEICommonProjectSettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOEICommonProjectSettings_Statics::NewProp_CrashBuddyConfigFile,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOEICommonProjectSettings_Statics::NewProp_ChatterEventQueueTime,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOEICommonProjectSettings_Statics::NewProp_ChatterEventWaitTime,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOEICommonProjectSettings_Statics::NewProp_ChatterEventQueueProcessLimit,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOEICommonProjectSettings_Statics::NewProp_bShowTextReviewPrefixes,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOEICommonProjectSettings_Statics::NewProp_WorldRuntimeClassName,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOEICommonProjectSettings_Statics::NewProp_ExportedFolder,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOEICommonProjectSettings_Statics::NewProp_DesignSourceFolder,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOEICommonProjectSettings_Statics::NewProp_DesignStagingFolder,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOEICommonProjectSettings_Statics::NewProp_OverrideFolder,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOEICommonProjectSettings_Statics::NewProp_QuickSaveFilename,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOEICommonProjectSettings_Statics::NewProp_SaveBeforeLinkFilename,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOEICommonProjectSettings_Statics::NewProp_AutoSaveFilename,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOEICommonProjectSettings_Statics::NewProp_SaveFileExtension,
	};
	const FCppClassTypeInfoStatic Z_Construct_UClass_UOEICommonProjectSettings_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<UOEICommonProjectSettings>::IsAbstract,
	};
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UOEICommonProjectSettings_Statics::ClassParams = {
		&UOEICommonProjectSettings::StaticClass,
		"Game",
		&StaticCppClassTypeInfo,
		DependentSingletons,
		nullptr,
		Z_Construct_UClass_UOEICommonProjectSettings_Statics::PropPointers,
		nullptr,
	...
	UClass* Z_Construct_UClass_UOEICommonProjectSettings()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UOEICommonProjectSettings_Statics::ClassParams);
		}
		return OuterClass;
	}
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UOEICommonProjectSettings(Z_Construct_UClass_UOEICommonProjectSettings, &UOEICommonProjectSettings::StaticClass, TEXT("/Script/OEICommon"), TEXT("UOEICommonProjectSettings"), false, nullptr, nullptr, nullptr);
	DEFINE_VTABLE_PTR_HELPER_CTOR(UOEICommonProjectSettings);
