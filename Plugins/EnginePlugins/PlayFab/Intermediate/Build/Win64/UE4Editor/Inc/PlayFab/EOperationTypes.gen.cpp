...
#include "PlayFab/Public/EOperationTypes.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeEOperationTypes() {}
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_PlayFab_EOperationTypes_Hash() { return 4062091444U; }
	UEnum* Z_Construct_UEnum_PlayFab_EOperationTypes()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "EOperationTypes::pfenum_MAX", (int64)EOperationTypes::pfenum_MAX },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "BlueprintType", "true" },
				{ "ModuleRelativePath", "Public/EOperationTypes.h" },
				{ "pfenum_Created.Name", "EOperationTypes::pfenum_Created" },
				{ "pfenum_Deleted.Name", "EOperationTypes::pfenum_Deleted" },
				{ "pfenum_MAX.Hidden", "" },
				{ "pfenum_MAX.Name", "EOperationTypes::pfenum_MAX" },
