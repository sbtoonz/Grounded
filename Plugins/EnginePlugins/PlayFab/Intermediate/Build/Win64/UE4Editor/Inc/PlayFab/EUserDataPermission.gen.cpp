...
#include "PlayFab/Public/EUserDataPermission.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeEUserDataPermission() {}
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_PlayFab_EUserDataPermission_Hash() { return 2781725102U; }
	UEnum* Z_Construct_UEnum_PlayFab_EUserDataPermission()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "EUserDataPermission::pfenum_MAX", (int64)EUserDataPermission::pfenum_MAX },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "BlueprintType", "true" },
				{ "ModuleRelativePath", "Public/EUserDataPermission.h" },
				{ "pfenum_MAX.Hidden", "" },
				{ "pfenum_MAX.Name", "EUserDataPermission::pfenum_MAX" },
