...
#include "PlayFab/Public/EEffectType.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeEEffectType() {}
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_PlayFab_EEffectType_Hash() { return 3076871690U; }
	UEnum* Z_Construct_UEnum_PlayFab_EEffectType()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "EEffectType::pfenum_MAX", (int64)EEffectType::pfenum_MAX },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "ModuleRelativePath", "Public/EEffectType.h" },
				{ "pfenum_Allow.Name", "EEffectType::pfenum_Allow" },
				{ "pfenum_Deny.Name", "EEffectType::pfenum_Deny" },
				{ "pfenum_MAX.Hidden", "" },
				{ "pfenum_MAX.Name", "EEffectType::pfenum_MAX" },
			};
#endif
