...
#include "PlayFab/Public/ESegmentPushNotificationDevicePlatform.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeESegmentPushNotificationDevicePlatform() {}
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_PlayFab_ESegmentPushNotificationDevicePlatform_Hash() { return 2376724053U; }
	UEnum* Z_Construct_UEnum_PlayFab_ESegmentPushNotificationDevicePlatform()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "ESegmentPushNotificationDevicePlatform::pfenum_MAX", (int64)ESegmentPushNotificationDevicePlatform::pfenum_MAX },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "ModuleRelativePath", "Public/ESegmentPushNotificationDevicePlatform.h" },
				...
				{ "pfenum_MAX.Hidden", "" },
				{ "pfenum_MAX.Name", "ESegmentPushNotificationDevicePlatform::pfenum_MAX" },
			};
#endif
