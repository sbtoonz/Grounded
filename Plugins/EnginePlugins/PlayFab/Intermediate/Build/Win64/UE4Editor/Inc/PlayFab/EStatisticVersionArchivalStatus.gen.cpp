...
#include "PlayFab/Public/EStatisticVersionArchivalStatus.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeEStatisticVersionArchivalStatus() {}
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_PlayFab_EStatisticVersionArchivalStatus_Hash() { return 757827546U; }
	UEnum* Z_Construct_UEnum_PlayFab_EStatisticVersionArchivalStatus()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "EStatisticVersionArchivalStatus::pfenum_MAX", (int64)EStatisticVersionArchivalStatus::pfenum_MAX },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "ModuleRelativePath", "Public/EStatisticVersionArchivalStatus.h" },
				...
				{ "pfenum_MAX.Hidden", "" },
				{ "pfenum_MAX.Name", "EStatisticVersionArchivalStatus::pfenum_MAX" },
