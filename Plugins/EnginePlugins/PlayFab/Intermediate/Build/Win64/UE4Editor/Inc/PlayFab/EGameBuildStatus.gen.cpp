...
#include "PlayFab/Public/EGameBuildStatus.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeEGameBuildStatus() {}
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_PlayFab_EGameBuildStatus_Hash() { return 1367443400U; }
	UEnum* Z_Construct_UEnum_PlayFab_EGameBuildStatus()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "EGameBuildStatus::pfenum_MAX", (int64)EGameBuildStatus::pfenum_MAX },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "BlueprintType", "true" },
				{ "ModuleRelativePath", "Public/EGameBuildStatus.h" },
				...
				{ "pfenum_MAX.Hidden", "" },
				{ "pfenum_MAX.Name", "EGameBuildStatus::pfenum_MAX" },
