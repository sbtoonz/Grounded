...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_K4VZ[0x58];                                  // 0x0028(0x0058) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_B3XC[0x17];                                  // 0x0099(0x0017) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3JYR[0x2];                                   // 0x00C2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IVHG[0x3];                                   // 0x00C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FRRF[0x4];                                   // 0x00D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_DX3X[0x2C];                                  // 0x00F4(0x002C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_V8HR[0x8];                                   // 0x0130(0x0008) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x0220 (FullSize[0x0910] - InheritedSize[0x06F0])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_MLVT[0x3];                                   // 0x06F1(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_AM9V[0x3];                                   // 0x06F5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_D7BQ[0x4];                                   // 0x070C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UU5Q[0x1F8];                                 // 0x0718(0x01F8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_UF7J[0x1];                                   // 0x00DB(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MRHZ[0x3];                                   // 0x00F5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TG1G[0xB0];                                  // 0x0100(0x00B0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_XFNE[0x3];                                   // 0x0089(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
