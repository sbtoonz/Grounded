...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_0IR3[0x8];                                   // 0x0228(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_T2V1[0x3];                                   // 0x0679(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5H75[0x4];                                   // 0x0684(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SR2Y[0x20];                                  // 0x0698(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_I2I4[0x28];                                  // 0x06C8(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_TNX8[0x80];                                  // 0x0028(0x0080) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_B4DW[0x168];                                 // 0x0028(0x0168) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_MN6M[0x78];                                  // 0x0068(0x0078) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_SBU4[0x38];                                  // 0x0068(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_PAC0[0x68];                                  // 0x0068(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_MX4P[0x50];                                  // 0x0030(0x0050) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_SYP1[0x18];                                  // 0x03C8(0x0018) MISSED OFFSET (PADDING)
