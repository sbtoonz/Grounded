...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Termite_Soldier.BP_Termite_Soldier_C
	 * Size -> 0x0081 (FullSize[0x12F1] - InheritedSize[0x1270])
	 */
	class ABP_Termite_Soldier_C : public ASurvivalCreature
	{
	public:
		...
		float                                                      Timeline_EyeColor02_NewTrack_0_781152894AE00243665D1D95E6D22423; // 0x12A0(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash
		ETimelineDirection                                         Timeline_EyeColor02__Direction_781152894AE00243665D1D95E6D22423; // 0x12A4(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_DB0W[0x3];                                   // 0x12A5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		float                                                      Timeline_EyeColor_NewTrack_0_3A034D064711807FA2902CA2C5351BC9; // 0x12B0(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash
		ETimelineDirection                                         Timeline_EyeColor__Direction_3A034D064711807FA2902CA2C5351BC9; // 0x12B4(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_1NTD[0x3];                                   // 0x12B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BP_Termite_Soldier(int32_t EntryPoint);
