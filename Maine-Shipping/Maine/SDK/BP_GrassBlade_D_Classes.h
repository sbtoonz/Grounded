...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_Z4DC[0x7];                                   // 0x03F9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BP_GrassBlade_D(int32_t EntryPoint);
