...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass UI_StatusEffectWidget.UI_StatusEffectWidget_C
	 * Size -> 0x0029 (FullSize[0x02A1] - InheritedSize[0x0278])
	 */
	class UUI_StatusEffectWidget_C : public UGameUserWidget
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_UI_StatusEffectWidget(int32_t EntryPoint);
