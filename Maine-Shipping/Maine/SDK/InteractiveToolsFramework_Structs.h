...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_IAW7[0xAC];                                  // 0x0000(0x00AC) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_VE3I[0x18];                                  // 0x0008(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_0GNO[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_6S6G[0x28];                                  // 0x0000(0x0028) MISSED OFFSET (PADDING)
	};
