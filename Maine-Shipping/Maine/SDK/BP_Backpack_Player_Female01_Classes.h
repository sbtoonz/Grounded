...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Backpack_Player_Female01.BP_Backpack_Player_Female01_C
	 * Size -> 0x000C (FullSize[0x0350] - InheritedSize[0x0344])
	 */
	class ABP_Backpack_Player_Female01_C : public ABP_Backpack_Player_C
	{
	public:
		unsigned char                                              UnknownData_B4TI[0x4];                                   // 0x0344(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
