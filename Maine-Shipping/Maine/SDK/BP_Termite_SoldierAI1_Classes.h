...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Termite_SoldierAI1.BP_Termite_SoldierAI1_C
	 * Size -> 0x0010 (FullSize[0x05B0] - InheritedSize[0x05A0])
	 */
	class ABP_Termite_SoldierAI1_C : public ASurvivalAIController
	{
	public:
	...
	public:
		void ExecuteUbergraph_BP_Termite_SoldierAI1(int32_t EntryPoint);
