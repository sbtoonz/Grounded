...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_World_Mosquito_Egg.BP_World_Mosquito_Egg_C
	 * Size -> 0x0028 (FullSize[0x0468] - InheritedSize[0x0440])
	 */
	class ABP_World_Mosquito_Egg_C : public ABP_WorldItem_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_World_Mosquito_Egg(int32_t EntryPoint);
