...
namespace CG
{
	 ...
	 */
	struct UEnvQueryContext_SearchLocation_C_ProvideSingleLocation_Params
	{
	public:
		...
		unsigned char                                              UnknownData_VTV3[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
