...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_VOZ4[0x2];                                   // 0x023E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_VZLA[0x3];                                   // 0x0235(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_JTPU[0x10];                                  // 0x0800(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3E8E[0xC];                                   // 0x0884(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5YK9[0x8];                                   // 0x08E8(0x0008) MISSED OFFSET (PADDING)
