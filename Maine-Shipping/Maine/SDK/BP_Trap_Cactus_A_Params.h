...
namespace CG
{
	 ...
	 */
	struct ABP_Trap_Cactus_A_C_IsInteractionEnabled_Params
	{
	public:
		...
		unsigned char                                              UnknownData_EMVI[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
