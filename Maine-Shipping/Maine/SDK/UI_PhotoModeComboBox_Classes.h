...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass UI_PhotoModeComboBox.UI_PhotoModeComboBox_C
	 * Size -> 0x0010 (FullSize[0x02C8] - InheritedSize[0x02B8])
	 */
	class UUI_PhotoModeComboBox_C : public UPhotoModeSettingWidget
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_UI_PhotoModeComboBox(int32_t EntryPoint);
