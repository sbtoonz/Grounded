...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass AB_Stinkbug.AB_Stinkbug_C
	 * Size -> 0x0EA0 (FullSize[0x1200] - InheritedSize[0x0360])
	 */
	class UAB_Stinkbug_C : public UCharacterAnimInstance
	{
	public:
		...
		struct FAnimNode_RandomPlayer                              AnimGraphNode_RandomPlayer;                              // 0x0820(0x0078)
		struct FAnimNode_BlendListByBool                           AnimGraphNode_BlendListByBool_2;                         // 0x0898(0x00A0)
	...
	public:
		...
		void EvaluateGraphExposedInputs_ExecuteUbergraph_AB_Stinkbug_AnimGraphNode_TransitionResult_81C9F2824A20C251F62FE29264537279();
		void EvaluateGraphExposedInputs_ExecuteUbergraph_AB_Stinkbug_AnimGraphNode_TransitionResult_CEF5381E46107EC8025735B1F5305E28();
		void EvaluateGraphExposedInputs_ExecuteUbergraph_AB_Stinkbug_AnimGraphNode_TransitionResult_E03DB4134DE598B1333A8DB54739E117();
		void EvaluateGraphExposedInputs_ExecuteUbergraph_AB_Stinkbug_AnimGraphNode_TransitionResult_9F282ADC4EA7D2B8C799B7B94191A931();
		void ExecuteUbergraph_AB_Stinkbug(int32_t EntryPoint);
