...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Backpack_Player_Female02.BP_Backpack_Player_Female02_C
	 * Size -> 0x000C (FullSize[0x0350] - InheritedSize[0x0344])
	 */
	class ABP_Backpack_Player_Female02_C : public ABP_Backpack_Player_C
	{
	public:
		unsigned char                                              UnknownData_07L9[0x4];                                   // 0x0344(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
