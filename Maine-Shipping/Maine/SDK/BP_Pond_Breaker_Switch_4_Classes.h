...
namespace CG
{
	 ...
	 */
	class ABP_Pond_Breaker_Switch_3_C : public ABP_Pond_Breaker_Switch_Base_C
	{
	public:
		unsigned char                                              UnknownData_2I6W[0x4];                                   // 0x044C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BP_Pond_Breaker_Switch_4(int32_t EntryPoint);
