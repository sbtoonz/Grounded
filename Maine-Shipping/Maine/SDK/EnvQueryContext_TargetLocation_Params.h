...
namespace CG
{
	 ...
	 */
	struct UEnvQueryContext_TargetLocation_C_ProvideSingleLocation_Params
	{
	public:
		...
		unsigned char                                              UnknownData_708O[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
