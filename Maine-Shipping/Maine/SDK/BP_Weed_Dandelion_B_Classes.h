...
namespace CG
{
	...
	public:
		...
		class USkeletalMeshComponent*                              SK_Dandelion_Leaf_B;                                     // 0x0420(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void ExecuteUbergraph_BP_Weed_Dandelion_B(int32_t EntryPoint);
