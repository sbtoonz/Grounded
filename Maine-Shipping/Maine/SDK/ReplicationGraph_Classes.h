...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_ODTN[0x40];                                  // 0x0058(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8NJV[0x3E0];                                 // 0x00B8(0x03E0) Fix size for supers
	...
	public:
		...
		unsigned char                                              UnknownData_RRF8[0x8];                                   // 0x04C8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_JBJ8[0x18];                                  // 0x0038(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_GBO0[0xA8];                                  // 0x0050(0x00A8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_89HQ[0xE8];                                  // 0x0050(0x00E8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_H7AR[0x30];                                  // 0x00F8(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_NVMR[0x98];                                  // 0x00F8(0x0098) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_FXR3[0x10];                                  // 0x00F8(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_YN43[0x48];                                  // 0x00F8(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_UJTK[0x1E0];                                 // 0x0050(0x01E0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_66AP[0x10];                                  // 0x0058(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_9E07[0x18];                                  // 0x00F8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_6B6N[0x18];                                  // 0x0060(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_0QH6[0x140];                                 // 0x0030(0x0140) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_DU51[0x10];                                  // 0x0178(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<struct FLastLocationGatherInfo>                     LastGatherLocations;                                     // 0x0188(0x0010) ZeroConstructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_QEJC[0x8];                                   // 0x0198(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BC95[0x80];                                  // 0x01B8(0x0080) MISSED OFFSET (PADDING)
	...
	{
	public:
		class UReplicationGraph*                                   ReplicationGraph;                                        // 0x0230(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		class UNetReplicationGraphConnection*                      ConnectionManager;                                       // 0x0238(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
