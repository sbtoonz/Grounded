...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_GrassBladeStumpFull_Dry.BP_GrassBladeStumpFull_Dry_C
	 * Size -> 0x0028 (FullSize[0x0380] - InheritedSize[0x0358])
	 */
	class ABP_GrassBladeStumpFull_Dry_C : public ABP_BASE_Stump_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_GrassBladeStumpFull_Dry(int32_t EntryPoint);
