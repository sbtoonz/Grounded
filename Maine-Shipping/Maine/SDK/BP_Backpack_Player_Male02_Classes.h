...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Backpack_Player_Male02.BP_Backpack_Player_Male02_C
	 * Size -> 0x000C (FullSize[0x0350] - InheritedSize[0x0344])
	 */
	class ABP_Backpack_Player_Male02_C : public ABP_Backpack_Player_C
	{
	public:
		unsigned char                                              UnknownData_NATE[0x4];                                   // 0x0344(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
